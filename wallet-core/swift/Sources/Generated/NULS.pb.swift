...
extension TW_NULS_Proto_Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _txData: Data = SwiftProtobuf.Internal.emptyData
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularUInt32Field(value: &_storage._timestamp)
        case 3: try decoder.decodeSingularStringField(value: &_storage._remark)
        case 4: try decoder.decodeSingularBytesField(value: &_storage._txData)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._input)
        case 6: try decoder.decodeSingularMessageField(value: &_storage._output)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._txSigs)
        case 8: try decoder.decodeSingularUInt32Field(value: &_storage._hash)
        default: break
        }
      }
    }
